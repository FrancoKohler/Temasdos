const precios = {
  ...
  comunYUTCMA: [
    { material: "SERIE 1", valor: "827" },
    { material: "SERIE 2", valor: "862" },
    { material: "SERIE 3", valor: "898" },
    { material: "SERIE 4", valor: "935" },
    { material: "SERIE 5", valor: "990" },
    { material: "SERIE 6", valor: "1044" },
    { material: "SERIE 7", valor: "1.116" },
    { material: "Promo", valor: "1.114" },
    { material: "Piel A", valor: "1.181" },
    { material: "PIEL B", valor: "1.275" },
    { material: "PIEL C", valor: "1.436" },
    { material: "PIEL D", valor: "1.625" },
  ],
  comunYUTCME: [
    { material: "SERIE 1", valor: "877" },
    { material: "SERIE 2", valor: "915" },
    { material: "SERIE 3", valor: "955" },
    { material: "SERIE 4", valor: "955" },
    { material: "SERIE 5", valor: "1.055" },
    { material: "SERIE 6", valor: "1.114" },
    { material: "SERIE 7", valor: "1.194" },
    { material: "Promo", valor: "1.363" },
    { material: "Piel A", valor: "1.450" },
    { material: "PIEL B", valor: "1.572" },
    { material: "PIEL C", valor: "1.781" },
    { material: "PIEL D", valor: "2.024" },
  ],
};
const piezas = [
  {
